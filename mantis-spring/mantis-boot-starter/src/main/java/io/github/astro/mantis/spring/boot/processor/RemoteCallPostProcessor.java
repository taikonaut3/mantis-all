...
import io.github.astro.mantis.spring.boot.RemoteCallFactoryBean;
...
public class RemoteCallPostProcessor implements BeanDefinitionRegistryPostProcessor {
    ...
    public RemoteCallPostProcessor(EnableMantis enableMantis) {
        ArrayList<String> list = new ArrayList<>();
        Collections.addAll(list, enableMantis.scanBasePackages());
        Collections.addAll(list, enableMantis.callsScan());
        this.remoteCallPackages = list.toArray(new String[0]);
    }
