...
public abstract class AbstractEndpointServer extends EndpointAdapter implements EndpointServer {

    private static final Logger logger = LoggerFactory.getLogger(AbstractEndpointServer.class);
    ...
    protected AbstractEndpointServer(URL url, ChannelHandler channelHandler, Codec codec) throws BindException {
