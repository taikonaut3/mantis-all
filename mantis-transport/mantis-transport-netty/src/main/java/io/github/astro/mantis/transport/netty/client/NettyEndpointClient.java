...
import io.github.astro.mantis.transport.client.AbstractEndpointClient;
...
public final class NettyEndpointClient extends AbstractEndpointClient {
    ...
    public NettyEndpointClient(URL url, ChannelHandler channelHandler, Codec codec) throws ConnectException {
