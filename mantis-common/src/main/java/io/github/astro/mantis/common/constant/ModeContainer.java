...
import static io.github.astro.mantis.common.constant.KeyValues.Envelope.*;
import static io.github.astro.mantis.common.constant.KeyValues.Protocol.MANTIS;
import static io.github.astro.mantis.common.constant.KeyValues.Serialize.*;
...
public class ModeContainer {
    ...
    static {
        ...
        put(Key.PROTOCOL, MANTIS, (byte) 1);
    }
