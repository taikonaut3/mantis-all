...
@SupportedAnnotationTypes({"io.github.astro.mantis.configuration.spi.ServiceInterface",
        "io.github.astro.mantis.configuration.spi.ServiceProvider"})
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        for (Element element : serviceInterfaceElements) {
            if (element instanceof TypeElement typeElement) {
                List<? extends AnnotationMirror> annotationMirrors = typeElement.getAnnotationMirrors().stream().filter(annotationMirror -> annotationMirror.getAnnotationType().toString().equals("io.github.astro.mantis.configuration.spi.ServiceProvider")).toList();
